...
* High-quality, auto-cropped, low-filesize PDFs -- no more difficult-to-read scans or submission of multiple photograph image files.
* Submission takes around 90 seconds.
* The app can send students automated reminders of deadlines.
...
The Gradescope app can be downloaded from the iOS or Android app stores. On iOS, the full name of the app "Gradescope – Assessment Anywhere" and it has a blue barchart icon.
 
Logging onto the app is a little bit of a hassle. On first use of the app, you will have to go through the following steps:
...
On subsequent log-ins after the first time, "University of Leeds" will be pre-selected on the first step, and it shouldn't necessary to repeat the fourth and fifth steps.
...
7. You now need to "assign" (or "tag") your pages. Click "Asign pages".
